...
if __name__ == '__main__':
    ...
    for i, file in enumerate(filelist):
        ...
        scale_list = [img.shape[3] if i % 2 == 0 else img.shape[2] for i in range(landmark_num * 2)]
        scale1 = torch.Tensor(scale_list)
        ...
        # --------------------------------------------------------------------
        save_name = os.path.join(args.save_folder, file_base + ".txt")
